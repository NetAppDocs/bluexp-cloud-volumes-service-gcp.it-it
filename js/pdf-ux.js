$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/it-it/cloud-manager-cloud-volumes-service-gcp/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-gcp.it-it.zip";
